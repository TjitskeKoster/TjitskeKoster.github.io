          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/talks/" -%}{%- assign url = "/talks/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/talks/" -%}{%- assign url = "/talks/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
